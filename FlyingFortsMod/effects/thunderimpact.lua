...
Effects =
{
	...
	--[[{
		...
		Sound = path .. "/effects/media/thunderimpact.ogg",
		Volume = 0.45,
		Priority = 192,
		Repeat = false,
...
SoundEvent = "mods/sbFFsoundbank/effects/thunderimpact"
--[[
ImpactSounds =
{
